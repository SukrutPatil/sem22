...
public class W6D5StudyHallErrorTerm {
	...
	private static boolean isFinalState(int state) {
		switch (state) {
		case 0: return false;
		case 1: // This is a stub that must be filled in
		case 2: // This is a stub that must be filled in
		case 3: // This is a stub that must be filled in
		case 4: // This is a stub that must be filled in
		case 5: return false;
		case 6: return false;
		case 7: return true;
	...
	private static String executeFSM(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				currentChar == '4' || currentChar == '5' || currentChar == '6' || currentChar == '7' || currentChar == '8' ||
				currentChar == '9') {
			state = 1;
			break;
		}
