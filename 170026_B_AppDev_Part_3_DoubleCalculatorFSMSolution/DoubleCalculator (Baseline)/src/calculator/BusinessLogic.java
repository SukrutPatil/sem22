 ...
 * 
 * @version 4.2	2018-02-02 The JavaFX-based GUI implementation of a long integer calculator 
 * 
 */
...
public class BusinessLogic {
	...
	**********************************************************************************************/
	 ...
	 * This method contain the the exceptional handling logic so that when any number is divided by '0'
	 * the program still runs successfully.
	 * The result is displayed as 'Infinity' and an error message is also generated as 'Invalid input' for the operand2
	 * */
	...
	public String division() {
		try {
			...
			result.div(operand2);
		    return result.toString();
		} catch (ArithmeticException e) {                        /**Catches the exception i.e. when divisor is zero*/
			String Errormessage= "";                             /**String to display the error message as Invalid input (operand2)*/
			resultErrorMessage = result.getZeroMessage();
