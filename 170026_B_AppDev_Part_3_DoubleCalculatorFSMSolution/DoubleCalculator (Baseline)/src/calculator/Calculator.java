 ...
 *         
 * @version 4.2	2018-02-24 The mainline of a JavaFX-based GUI implementation of a long integer calculator
 * 
 */
...
public class Calculator extends Application {
	...
	public void start(Stage theStage) throws Exception {
		...
		theStage.setTitle("Integer Calculator. By Sukrut Patil");				// Label the stage (a window)
