 ...
 * 
 * @version 4.2	2018-02-25 The JavaFX-based GUI for the implementation of a calculator
 * 
 */
...
public class UserInterface {
	...
	**********************************************************************************************/
	...
	private Label label_DoubleCalculator = new Label("Double Calculator V3");
	...
	private Label label_errOperand1x = new Label("");               
	private Label label_errOperand2x = new Label("");	            
	...
	**********************************************************************************************/
	...
	private void setOperand2() {
		text_Result.setText("");								   // Same logic as above
